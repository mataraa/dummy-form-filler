...
ActionButton({
	...
	worker = tabs.activeTab.attach({
		contentScriptFile : [ self.data.url("jquery-2.1.0.min.js"), self.data.url("chance.min.js"),
			self.data.url("dummy-logger.js"), self.data.url("dummy-purpose.js"), self.data.url("dummy-limits.js"), self.data.url("dummy-generator.js"), self.data.url("dummy-engine.js"),],
